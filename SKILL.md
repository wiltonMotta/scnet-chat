---
name: scnet-chat
description: 通过自然语言交互管理 SCNet Chat 超算平台，支持数据中心切换、用户信息查询、账户余额查询、作业管理和文件管理。
license: MIT
clawhub:
  slug: scnet-chat
...
通过自然语言交互，轻松管理 SCNet 超算平台的缓存、数据中心切换、用户信息查询、作业管理和文件管理。
