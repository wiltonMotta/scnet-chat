...
| 按状态筛选 | `查询运行中的作业`、`排队的作业`、`完成的作业` | 支持 running/queue/completed/exit |
| 按队列筛选 | `查询队列 debug 的作业`                        | 指定队列名                        |
| 按名称筛选 | `查询作业名称 test`                            | 支持模糊匹配                      |
| 分页查询   | `查询作业 第2页 每页20条`                      | 分页控制（默认第1页，每页10条）   |
...
| 历史时间范围 | `历史作业 开始时间 2024-01-01 结束时间 2024-01-31` | 历史作业指定查询时间范围      |
| 实时时间范围 | `查询作业 开始时间 2024-01-01 结束时间 2024-01-31` | 实时作业指定查询时间范围      |
| 最近N天(历史) | `历史作业 最近7天`                          | 查询最近N天的历史作业            |
