...
```bash
# 查看提交作业帮助
python scripts/scnet.py "如何提交作业"
python scripts/scnet.py "提交作业帮助"
python scripts/scnet.py "作业有哪些参数"
```
...
```bash
# 简单命令
python scripts/scnet.py "提交作业 sleep 900"

# 指定队列和运行时间
python scripts/scnet.py "提交作业 sleep 900 --queue comp --wall-time 00:30:00"

# 在指定中心提交作业
python scripts/scnet.py "在昆山提交作业 hostname"
python scripts/scnet.py "在山东提交作业 mpirun -np 4 ./myapp"

# MPI 并行作业
python scripts/scnet.py "提交作业 mpirun -np 8 ./myapp --queue normal --nnode 2 --job-name test-mpi"

# GPU 作业
python scripts/scnet.py "提交作业 ./gpu_program --queue gpu --ngpu 1 --job-mem 16GB"

# 完整参数示例
python scripts/scnet.py "提交作业 --cmd './myapp' --queue comp --nnode 2 --ppn 8 --wall-time 12:00:00 --job-name production-run"
```
...
```bash
# 缓存管理
python scripts/scnet.py "刷新缓存"

# 区域切换
python scripts/scnet.py "切换到山东"
python scripts/scnet.py "切换到西安"

# 用户信息查询
python scripts/scnet.py "查询用户"
python scripts/scnet.py "我的账户信息"
python scripts/scnet.py "作业统计"
python scripts/scnet.py "机时"

# 作业管理 - 查询（基础）
# ⚠️ 注意：实时作业列表和历史作业列表是全区域聚合查询，一次调用返回所有区域的作业
python scripts/scnet.py "查询作业"                      # 查询所有区域的实时作业
python scripts/scnet.py "查看运行中的作业"              # 查询所有区域运行中的作业
python scripts/scnet.py "历史作业"                      # 查询所有区域的历史作业
python scripts/scnet.py "作业详情 12345"                # 查询特定作业详情（需指定区域）

# 作业管理 - 查询（高级筛选）
python scripts/scnet.py "查询作业 第2页 每页20条"
python scripts/scnet.py "查询队列 debug 的作业 所有字段"
python scripts/scnet.py "查询用户 zhangsan 的作业"
python scripts/scnet.py "查询组作业"
python scripts/scnet.py "查询区域ID 12345 的作业"       # 筛选特定区域的作业

# 作业管理 - 历史作业查询（高级用法）
python scripts/scnet.py "历史作业 开始时间 2024-01-01 00:00:00 结束时间 2024-01-31 23:59:59"
python scripts/scnet.py "历史作业 最近7天"
python scripts/scnet.py "查询最近三天的历史作业"                    # 中文数字支持
python scripts/scnet.py "查询从2026-04-01到2026-04-03的历史作业"   # 简写日期范围
python scripts/scnet.py "查询历史作业，每页5条，显示第二页"         # 中文页码
python scripts/scnet.py "查询历史作业，状态为失败"                  # 中文状态筛选
python scripts/scnet.py "查询历史作业，队列为comp，每页10条"

# 作业管理 - 实时作业查询（高级用法）
python scripts/scnet.py "查询作业 开始时间 2024-01-01 00:00:00 结束时间 2024-01-31 23:59:59"
python scripts/scnet.py "查询最近3天的作业"
python scripts/scnet.py "查询运行中的作业，每页5条"
python scripts/scnet.py "查询作业，状态为排队，显示第2页"

# 作业管理 - 提交和删除
python scripts/scnet.py "提交作业"
python scripts/scnet.py "提交作业 --cmd 'mpirun -np 4 ./myapp' --queue normal"
python scripts/scnet.py "删除作业 12345"

# 作业管理 - 队列和集群
python scripts/scnet.py "查询队列"
python scripts/scnet.py "集群信息"

# 文件管理 - 列表和上传下载
python scripts/scnet.py "文件列表"
python scripts/scnet.py "查看文件 /public/home/user"
python scripts/scnet.py "上传文件 ./data.txt 到 /public/home/user/"
python scripts/scnet.py "下载文件 /public/home/user/result.txt 到 ./"

# 文件管理 - 创建和删除
python scripts/scnet.py "创建目录 /public/home/user/workspace"
python scripts/scnet.py "创建文件 /public/home/user/hello.txt"
python scripts/scnet.py "删除文件 /public/home/user/old.txt"

# 文件管理 - 复制移动和重命名
python scripts/scnet.py "复制文件 /src/data.txt 到 /dst/"
python scripts/scnet.py "移动文件 /src/data.txt 到 /dst/"
python scripts/scnet.py "重命名 /old/name.txt 为 newname.txt"

# 帮助
python scripts/scnet.py "帮助"
```

### 交互式使用

```bash
python scripts/scnet.py
...
- **`scripts/scnet.py`** 是**唯一推荐的入口**，支持自然语言交互
...
| 文件               | 说明                                                  |
| ------------------ | ----------------------------------------------------- |
| `scripts/scnet.py` | **主入口文件（推荐）**，支持自然语言意图识别和命令路由 |
...
- **统一入口**：所有操作通过 `scripts/scnet.py` 的自然语言接口完成
